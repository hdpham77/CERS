...
(function ($) {
	$.extend({
		jixedbar: new function (options) {
			var constants = { constOverflow: "hidden", constBottom: "0px" };
			var defaults = { showOnTop: false, transparent: false, opacity: 0.9, opaqueSpeed: "fast", slideSpeed: "fast", roundedCorners: true, roundedButtons: true, menuFadeSpeed: 250, tooltipFadeSpeed: "slow", tooltipFadeOpacity: 0.8 };
			var options = $.extend(defaults, options);
			var ie6 = (navigator.appName == "Microsoft Internet Explorer" && parseInt(navigator.appVersion) == 4 && navigator.appVersion.indexOf("MSIE 6.0") != -1);
			var ie7 = (document.all && !window.opera && window.XMLHttpRequest);
			var button_active = false; var active_button_name = "";
			var element_obj;
			...
			this.construct = function () {
				return this.each(function () {
					...
					if ($.browser.msie && ie6) {
						$("#jx-hid-con-id").css({ "width": "1px", "float": "right" });
					}
					else if ($.browser.msie && ie7) {
						$("#jx-hid-con-id").css({ "width": "40px", "float": "right" });
					}
					if (defaults.showOnTop) { hideIndicator = "jx-hide-top"; } else { hideIndicator = "jx-hide"; }
					$("#jx-hid-con-id").html('<li alt="Hide CERS Tray"><a id="jx-hid-btn-id" class="' + hideIndicator + '"></a></li>'); $("#jx-hid-con-id").addClass("jx-bar-button-right"); $("<span />").attr("id", "jx-hid-sep-id").insertAfter("#jx-hid-con-id"); $("#jx-hid-sep-id").addClass("jx-hide-separator"); $("#jx-hid-btn-id").parent().click(function () {
					...
					$("#jx-uhid-itm-id").html('<li alt="Show CERS Tray"><a id="jx-uhid-btn-id" class="' + unhideIndicator + '"></a></li>'); if (defaults.roundedCorners) { if (defaults.showOnTop) { $("#jx-uhid-con-id").addClass("jx-bar-rounded-bl jx-bar-rounded-br"); } else { $("#jx-uhid-con-id").addClass("jx-bar-rounded-tl jx-bar-rounded-tr"); } }
					...
					$("li", obj).each(function () { var _title = $(this).attr("title"); if (_title != "") { $(this).removeAttr("title"); $(this).attr("alt", _title); } }); $("li", obj).hover(function () {
						...
						//if (tooltipTitle != "" || toolTipTitle != 'undefined') {
						...
						//	$("<div />").html(tooltipTitle).appendTo("#" + barTooltipID); if ((!defaults.showOnTop) && !($.browser.msie && ie6)) { $("<div />").addClass("jx-tool-point-dir-down").appendTo("#" + barTooltipID); }
...
})(jQuery); jQuery.fn.exists = function () { return jQuery(this).length > 0; };
...
jQuery.fn.checkCookie = function (name) {
	var nameEQ = name + "=";
