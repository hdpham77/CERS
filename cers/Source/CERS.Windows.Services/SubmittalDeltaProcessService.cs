...
{
    partial class SubmittalDeltaProcessService : ServiceBase
    {
        private SubmittalDeltaServiceProcess _Process;

        public SubmittalDeltaProcessService()
        {
            InitializeComponent();
            RegenerateServiceName();
            _Process = new SubmittalDeltaServiceProcess();
        }
