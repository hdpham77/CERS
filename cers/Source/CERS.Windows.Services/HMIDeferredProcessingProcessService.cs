...
{
	partial class HMIDeferredProcessingProcessService : ServiceBase
	{
		private HazardousMaterialsInventoryDeferredProcessingService _Process;

		public HMIDeferredProcessingProcessService()
		{
			InitializeComponent();
			RegenerateServiceName();
			_Process = new HazardousMaterialsInventoryDeferredProcessingService();
		}
